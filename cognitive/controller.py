...
class AIController:
    ...
    def evaluate_and_update(self, state: Dict[str, Any], current_desired_spec: Dict[str, Any]) -> Dict[str, Any]:
        """
...
"""
    ...
    def _heuristic_fallback(self, state: Dict[str, Any], current_desired_spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        all_done = True
        for task in tasks:
            status_entry = state.get(task["id"])
