...
class CognitiveSystem:
    def __init__(
        ...
        # Memory stores
        self.short_term_memory: List[Dict[str, Any]] = []  # Contextual sequence of last observations
        self.long_term_memory: Dict[str, Any] = {}   # Persistent summarized statistics

    def ingest_observation(self, committed_state: Dict[str, Any]) -> None:
        """
        Ingests the latest committed state machine state.
        Updates short term memory buffer and long term summary counters.
        """
        self.short_term_memory.append(copy.deepcopy(committed_state))
    ...
    def execute_tools(self, command_spec: Any) -> Dict[str, Any]:
        """
    ...
    def plan_new_tasks(self, goal_description: str) -> List[Dict[str, Any]]:
        """
